...
!!! note "本节内容截至 2026 年 7 月"
    这是全书时效性最强的一节。此阶段仍在演进中，其中的"规律"是对进行时的观察而非定论。

### 已经发生的事（截至 2026 年年中）

**Robotaxi 从"试点"变成"生意"：**

- **Waymo 规模化**：2026 年 2 月完成 160 亿美元融资（估值 1 260 亿美元），同月一次性开放达拉斯、休斯敦、圣安东尼奥、奥兰多，美国商业运营都会区超过 10 个；7 月周订单约 50 万单，车队约 4 000 辆，目标年底 100 万单/周；基于吉利极氪 RT 的第六代平台于 2026 年 5 月起载客；4 月在伦敦启动测试；
- **Tesla Robotaxi 落地但规模有限**：2025 年 6 月奥斯汀首发，2026 年扩展至达拉斯、休斯敦、迈阿密；Cybercab 于 2026 年 2 月下线、4 月进入连续生产，9 月 4 日起在奥斯汀付费载客。但无监督运营车辆仍仅数十辆，NHTSA 对 FSD 的调查在 2026 年 3 月升级为工程分析，并于 9 月 3 日就 Cybercab 的自我认证另开审计问询（AQ26002）；
- **中国企业大规模出海**：萝卜快跑累计订单突破 2 200 万次、覆盖 27 城，并进入阿布扎比、迪拜、瑞士（获 L4 特别许可）、韩国、中国香港；文远知行与 Uber 在阿布扎比、迪拜实现全无人收费运营；小马智行宣布第七代车型在广州实现**单车运营盈利**——中国市场首个公开的单城盈利宣称。

**算法从"端到端"走向"VLA + 世界模型"：**

- 小鹏 **VLA 2.0**（2026-03 量产推送，取消中间语言层，时延 < 80 ms）、理想 **MindVLA-o1**、蔚来 **NWM** 第二代、Momenta **R7** 强化学习世界模型相继量产；
- 华为 **乾崑 ADS 5**（2026-04）以 WEWA 2.0 架构宣布进入 L3 规模商用元年，累计辅助驾驶里程突破 100 亿公里；
- Waymo 公开 **Waymo Foundation Model**（2025-12）与基于 Genie 3 的 **Waymo World Model**（2026-02）；NVIDIA 开源 **Alpamayo** 系列推理 VLA 模型与 **Cosmos 3** 世界基础模型；Wayve 发布 **GAIA-3**。

**芯片自研从头部扩散：**

- NVIDIA Thor 进入量产交付（奔驰 CLA 成为首款搭载 NVIDIA 全栈方案的量产车）；
- 车企自研芯片密集上车：小鹏图灵、蔚来神玑 NX9031（全球首颗车规级 5nm）、理想马赫 M100；地平线征程 6P 与 HSD 全栈方案量产；Tesla AI5 于 2026 年 4 月流片。

**监管从"鼓励快跑"转向"先划底线"：**

- 2025 年 3 月小米 SU7 高速事故（3 人死亡）成为转折点，同年 4 月工信部整顿宣传，全行业由"智驾"改称"辅助驾驶"；
- 2025 年 12 月中国发放**首批 L3 生产准入**（长安深蓝 SL03、北汽极狐阿尔法 S6）；
- 2026 年 7 月发布 **GB 47955—2026**，首个 L2 组合驾驶辅助强制性国标（2027-01-01 实施）；
- 美国《SELF DRIVE Act of 2026》进入立法程序；NHTSA 就自动驾驶与急救人员交互问题致函全行业。
...
- **全球化不再是"技术输出"而是"合规本地化"**：Waymo 伦敦行、萝卜快跑瑞士行、中国公司中东行皆如此；
- **规模本身成为新的风险源**：2026 年 Waymo 两起召回各覆盖近 4 000 辆（几乎全部车队），萝卜快跑在武汉发生上百辆同时趴窝的云端故障——当软件统一、车队庞大时，单个缺陷会同时作用于所有车辆。

> **规律 6：下一个十年的胜负手不再是"能不能做"，而是"能不能在每个市场都做"。**

> **规律 7：规模化不是终点而是新问题的起点——车队越大，单点缺陷的爆炸半径越大，工程重心从"让它能开"转向"让它在千辆规模上不同时出错"。**
...
- [§7 实例](../casestudy/index.md) — 对主要公司技术栈的深入分析。
