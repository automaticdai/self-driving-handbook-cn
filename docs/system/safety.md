...
下图给出整车范围内各子系统的典型 ASIL 分配——注意 ADAS 感知链路（视觉/雷达/数据融合）与动力、转向、制动同属 ASIL-D 区间，而摄像头传感器本身仅为 ASIL-B：等级取决于失效后果，而非部件的技术复杂度。

![整车各子系统的典型 ASIL 等级分配](assets/asil-levels-by-subsystem.png)
