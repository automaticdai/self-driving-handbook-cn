...
| [第五章：仿真测试](simulation/main.md) | 仿真平台、环境建模、传感器仿真、场景生成、Sim-to-Real | 测试工程师、仿真开发者 |
| [第六章：视觉语言大模型](vlm/main.md) | VLM 基础模型、场景理解、决策规划、部署优化 | 算法研究者、AI 工程师 |
| [第七章：实例](casestudy/main.md) | Apollo、Waymo、Tesla、中国本土玩家、Robotaxi 商业模式 | 所有读者 |
