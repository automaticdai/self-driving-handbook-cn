...
!!! info "本节包含"
    - [SLAM 与融合定位](localisation_slam_fusion.md) — 激光/视觉 SLAM、VIO 紧耦合、因子图融合架构、GNSS/IMU 紧耦合、回环检测
    - [定位评估与运维](localisation_metrics_ops.md) — 指标体系、真值获取、失效模式分析、降级策略、运维平台与发布门禁
